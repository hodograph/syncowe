...
class CreateReimbursementForm extends ConsumerStatefulWidget
{
  ...
  @override
  ConsumerState<CreateReimbursementForm> createState() => _CreateReimbursementForm();
}
    ...
    if(tripId != null)
    {
      if(payTo != null)
      {
        if(_totalAmountController.doubleValue > 0)
        {
          ...
          await _tripFirestoreService.addOrUpdateReimbursement(reimbursement, tripId, null);
