...
class _TransactionPage extends ConsumerState<TransactionsPage>
{
  ...
  Widget build(BuildContext context) {
    ...
    return FirestorePagination(
      ...
      query: _tripFirestoreService.transactions(tripId!).orderBy(NameofTransaction.fieldCreatedDate, descending: true), 
      itemBuilder: (context, snapshot, index)
      {
        Future(() => ref.read(loadedTransactionsProvider.notifier).setTransactions(snapshot));
        ...
        return ListTile(
          ...
          onTap: () {
            ref.read(currentTransactionIdProvider.notifier).setTransactionId(snapshot[index].id);
