...
class _ReimbursementsPage extends ConsumerState<ReimbursementsPage>
{
  ...
  Widget build(BuildContext context) {
    ...
    return FirestorePagination(
      ...
      query: _tripFirestoreService.reimbursements(tripId!).orderBy(NameofReimbursement.fieldCreatedDate, descending: true), 
      itemBuilder: (context, snapshots, index)
      {
        ...
        if (reimbursement.recipient == currentUser?.id && !reimbursement.confirmed)
        {
          trailing = IconButton(onPressed: () async
          {
            ...
            if (confirmed == true)
            {
              ...
              _tripFirestoreService.addOrUpdateReimbursement(reimbursement, tripId, snapshots[index].id);
            }
          }, 
